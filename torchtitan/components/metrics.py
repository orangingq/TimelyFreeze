...
class WandBLogger(BaseLogger):
    ...
    def __init__(self, log_dir: str, job_config: JobConfig, tag: str | None = None):
        ...
        self.wandb.init(
            ...
            name=job_config.metrics.wandb_name or job_config.job.basename,
            dir=log_dir,
...
class MetricsProcessor:
    ...
    def log(
        ...
        self.time_delta_logs.append(time_delta) # : for final logging
        ...
        self.mfu_logs.append(mfu)  # : for final logging
